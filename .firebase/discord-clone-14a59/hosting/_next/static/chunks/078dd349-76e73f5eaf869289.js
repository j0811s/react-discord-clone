"use strict";(self.webpackChunk_N_E=self.webpackChunk_N_E||[]).push([[380],{5554:function(e,t,i){i.d(t,{X:function(){return eG},c:function(){return ty},o:function(){return t6}});var n,r=i(8954),s=i(5723),a=i(9858),o=i(9703),l=i(6574);function c(){return{"dependent-sdk-initialized-before-auth":"Another Firebase SDK was initialized and is trying to use Auth before Auth is initialized. Please be sure to call `initializeAuth` or `getAuth` before starting any other Firebase SDK."}}let u=new r.LL("auth","Firebase",c()),h=new a.Yd("@firebase/auth");function d(e){for(var t=arguments.length,i=Array(t>1?t-1:0),n=1;n<t;n++)i[n-1]=arguments[n];h.logLevel<=a.in.ERROR&&h.error("Auth (".concat(s.Jn,"): ").concat(e),...i)}/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class tg extends eP{_getIdTokenResponse(e){return eL(e,this._buildIdpRequest())}_linkToIdToken(e,t){return eL(e,this._buildIdpRequest(t))}_getReauthenticationResolver(e){return eL(e,this._buildIdpRequest())}_buildIdpRequest(e){let t={requestUri:this.params.requestUri,sessionId:this.params.sessionId,postBody:this.params.postBody,tenantId:this.params.tenantId,pendingToken:this.params.pendingToken,returnSecureToken:!0,returnIdpCredential:!0};return e&&(t.idToken=e),t}constructor(e){super("custom","custom"),this.params=e}}function tm(e){return e1(e.auth,new tg(e),e.bypassAuthState)}function tv(e){let{auth:t,user:i}=e;return v(i,t,"internal-error"),e0(i,new tg(e),e.bypassAuthState)}async function t_(e){let{auth:t,user:i}=e;return v(i,t,"internal-error"),eZ(i,new tg(e),e.bypassAuthState)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let tM=new y(3e4,6e4);function tU(){let e=e7().___jsl;if(null==e?void 0:e.H){for(let t of Object.keys(e.H))if(e.H[t].r=e.H[t].r||[],e.H[t].L=e.H[t].L||[],e.H[t].r=[...e.H[t].L],e.CP)for(let t=0;t<e.CP.length;t++)e.CP[t]=null}}let tx=null,tF=new y(5e3,15e3),tV={style:{position:"absolute",top:"-100px",width:"1px",height:"1px"},"aria-hidden":"true",tabindex:"-1"},tj=new Map([["identitytoolkit.googleapis.com","p"],["staging-identitytoolkit.sandbox.googleapis.com","s"],["test-identitytoolkit.sandbox.googleapis.com","t"]]);async function tz(e){let t=await (tx=tx||new Promise((t,i)=>{var n,r,s,a;function o(){tU(),gapi.load("gapi.iframes",{callback:()=>{t(gapi.iframes.getContext())},ontimeout:()=>{tU(),i(f(e,"network-request-failed"))},timeout:tM.get()})}if(null===(r=null===(n=e7().gapi)||void 0===n?void 0:n.iframes)||void 0===r?void 0:r.Iframe)t(gapi.iframes.getContext());else if(null===(s=e7().gapi)||void 0===s?void 0:s.load)o();else{let t=ey("iframefcb");return e7()[t]=()=>{gapi.load?o():i(f(e,"network-request-failed"))},(a="".concat(ew.gapiScript,"?onload=").concat(t),ew.loadJS(a)).catch(e=>i(e))}}).catch(e=>{throw tx=null,e})),i=e7().gapi;return v(i,e,"internal-error"),t.open({where:document.body,url:function(e){let t=e.config;v(t.authDomain,e,"auth-domain-config-required");let i=t.emulator?T(t,"emulator/auth/iframe"):"https://".concat(e.config.authDomain,"/").concat("__/auth/iframe"),n={apiKey:t.apiKey,appName:e.name,v:s.Jn},a=tj.get(e.config.apiHost);a&&(n.eid=a);let o=e._getFrameworks();return o.length&&(n.fw=o.join(",")),"".concat(i,"?").concat((0,r.xO)(n).slice(1))}(e),messageHandlersFilter:i.iframes.CROSS_ORIGIN_IFRAMES_FILTER,attributes:tV,dontclear:!0},t=>new Promise(async(i,n)=>{await t.restyle({setHideOnLeave:!1});let r=f(e,"network-request-failed"),s=e7().setTimeout(()=>{n(r)},tF.get());function a(){e7().clearTimeout(s),i(t)}t.ping(a).then(a,()=>{n(r)})}))}/**
 * @license
 * Copyright 2020 Google LLC.
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function(e){switch(e){case"Node":return"node";case"ReactNative":return"rn";case"Worker":return"webworker";case"Cordova":return"cordova";case"WebExtension":return"web-extension";default:return}}(n)),(0,s.KN)(t1,t2,"esm2017")}}]);